...
const Blog = () => {
  const discussionsData = [
    {
      ...
      summary:
        "Looking for advice on selecting a gaming laptop? Share your thoughts here!",
      author: "John Doe",
      authorAvatar:
    ...
    },
    {
      ...
      summary:
        "Discuss and troubleshoot common laptop problems with the community.",
      author: "Jane Smith",
      authorAvatar:
        "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80",
      image:
    ...
    },
    {
      ...
      summary:
        "Share your recommendations and experiences with laptops for coding.",
  ...
  const blogs = [
    ...
    },
    {
      id: 2,
      image:
        "https://images.unsplash.com/photo-1698434156086-918aa526b531?auto=format&fit=crop&q=80&w=1470&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      id: 4,
      image:
        "https://images.unsplash.com/photo-1593642634524-b40b5baae6bb?auto=format&fit=crop&q=80&w=1632&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    },
    {
      id: 5,
      image:
        "https://images.unsplash.com/photo-1487017159836-4e23ece2e4cf?auto=format&fit=crop&q=80&w=1471&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    ...
    <section class="my-14">
      <div class="container px-6 py-10 mx-auto">
        <h1
          ...
          class="text-2xl font-semibold capitalize md:text-3xl text-center pb-8"
        >
          Our latest blog
        </h1>
        ...
        <div
          data-aos="fade-up"
          data-aos-duration="1000"
          class="grid grid-cols-1 gap-14 mt-8 md:mt-16 md:grid-cols-2"
        >
          {blogs.map((blog) => (
            <div
              key={blog.id}
              class="lg:flex shadow shadow-secondary rounded-2xl p-2"
            >
              <img
                class="object-cover w-full h-56 rounded-lg lg:w-64 skew-y-1 skew-x-1"
                src={blog.image}
                alt=""
              />
              ...
              <div class="flex flex-col gap-3 justify-evenly py-6 lg:mx-6">
                ...
                <button className="shadow shadow-secondary rounded w-20 p-1">
                  See More
                </button>
              </div>
            </div>
