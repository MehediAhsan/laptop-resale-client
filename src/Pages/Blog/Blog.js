...
const Blog = () => {
  return (
    <div>
      <h1 className="text-3xl font-semibold text-center text-accent mt-20 mb-10">
        Q/A
      </h1>
      <div className="grid grid-cols-1 w-full md:w-9/12 mx-auto">
        ...
        <div className="p-7 lg:p-10">
          ...
          <p className="text-gray-500 text-lg ml-8">
            ...
            possible to mutate any member of the prototype chain or even swap
            out the prototype at runtime, so concepts like static dispatching do
            not exist in JavaScript. While this confusion is often considered to
            ...
            is, for example, fairly trivial to build a classic model on top of a
