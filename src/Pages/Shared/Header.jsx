...
const Header = () => {
    ...
    const menu = <React.Fragment>
        ...
        { user?.uid ? 
            ...
            <li><button className='btn btn-primary rounded text-white btn-outline mt' onClick={handleLogOut}>SignOut</button></li>
            </>
            :
            <li><Link className='btn btn-primary rounded text-white btn-outline mt-1' to='/login'>Login</Link></li>
        }
    </React.Fragment>
