    ...
    <section data-aos="fade-up" data-aos-duration="1000" className="py-36">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          <div className="p-6 text-primary shadow-md rounded-lg shadow-secondary">
            <div className="flex items-center justify-center w-12 h-12 bg-rose-400 rounded-full mb-4">
              <FaBriefcase className="text-white text-2xl" />
            </div>
            <h3 className="text-xl font-semibold "><CountUp start={0} end={200} duration={20} />+</h3>
          ...
          <div className="p-6 text-primary shadow-md rounded-lg shadow-secondary">
            ...
            <h3 className="text-xl font-semibold "><CountUp start={0} end={5000} duration={20} />+</h3>
