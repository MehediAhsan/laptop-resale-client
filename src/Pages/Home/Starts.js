...
const Starts = () => {
    return (
        <section data-aos="fade-up" className="p-4 my-32 md:p-8 text-gray-800 container mx-auto">
	<div className="container grid grid-cols-1 gap-6 m-4 mx-auto md:m-0 md:grid-cols-2 xl:grid-cols-3">
		<div className="flex overflow-hidden rounded-lg text-gray-900 border">
		...
		<div className="flex overflow-hidden rounded-lg text-gray-900 border">
			<div className="flex items-center justify-center px-4 bg-rose-400 dark:text-gray-800">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="currentColor" className="w-6 h-6">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-2xl font-semibold">7 <CountUp start={300} end={500} duration={10}></CountUp>+</p>
				<p>Buyers</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg text-gray-900 border">
			...
			<div className="flex items-center justify-between flex-1 p-3">
				<p className="text-2xl font-semibold">5 <CountUp start={300} end={500} duration={10}></CountUp>+</p>
				<p>Sellers</p>
			</div>
		</div>
		<div className="flex overflow-hidden rounded-lg text-gray-900 border">
