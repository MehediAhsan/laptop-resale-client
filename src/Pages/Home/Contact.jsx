...
const Contact = () => {
  ...
  return (
    <div data-aos="fade-up" data-aos-duration="1000" className="my-24">
      <SectionTitle one={"Contact"} two={"Us"}></SectionTitle>
        ...
        <form className="space-y-6 ng-untouched ng-pristine mt-14">
          <div>
            ...
            <input
              ...
              className="w-full p-3 rounded border text-black mt-1"
            />
          </div>
          <div>
          ...
          <button className="w-full p-3 text-sm font-semibold tracking-wide uppercase rounded border border-primary hover:bg-primary hover:text-black">
            Send Message
          </button>
        </form>
      </div>
